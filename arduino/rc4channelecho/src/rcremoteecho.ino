...
void doRCAction() {
  ch[STR] = pulseIn(A1, HIGH, 25000); // Read the pulse width of
  ch[THR] = pulseIn(A2, HIGH, 25000); // each channel
  ch[KILL] = pulseIn(A3, HIGH, 25000);
  ch[AUX] = pulseIn(A4, HIGH, 25000);
