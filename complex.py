...
D2 = Dense(32,W_regularizer=l2(0.001))(DED1)
ED2 = ELU()(D2)
...
ES1 = ELU()(S1)
DES1 = Dropout(0.5)(ES1)
S2 = Dense(32,W_regularizer=l2(0.001))(DES1)
ES2 = ELU()(S2)
S3 = Dense(32,W_regularizer=l2(0.001))(ES2)
ES3 = ELU()(S3)
...
EG1 = ELU()(G1)
DEG1 = Dropout(0.5)(EG1)
G2 = Dense(32,W_regularizer=l2(0.001))(DEG1)
EG2 = ELU()(G2)
G3 = Dense(32,W_regularizer=l2(0.001))(EG2)
EG3 = ELU()(G3)
